...
const plans = [
  {
    ...
    description:
      'Full-featured electromechanical CAD for personal projects. Free forever.',
    button: {
      label: 'Get started free',
      href: 'https://app.opennuts.com',
    },
    features: [
      'Unlimited projects',
      'Schematic capture & PCB layout',
      '3D mechanical design',
      'Gerber, BOM & STEP export',
  ...
  },
  {
    ...
    description:
      'For professionals who need deeper libraries, more storage, and direct support.',
    button: {
  ...
  },
  {
    ...
    description:
      'For hardware teams that need to collaborate and move fast. Per-seat pricing.',
    button: {
      label: 'Start free trial',
      href: 'https://app.opennuts.com',
    },
      ...
      <Container>
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-2 text-lg text-gray-600">
            The Community plan is free forever. Upgrade when you need
            collaboration, advanced features, or team management.
          </p>
        </div>
